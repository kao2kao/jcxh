...
module.exports = {
    ...
    encrypt_key : 'dora',
//    数据库配置
    //DBURL: 'mongodb://115.29.44.230:27017/doracms',
    DBOptions: {'user': 'kaokao', 'pass': 'kao123456kao'},
    URL: 'mongodb://127.0.0.1:27017/doracms',
    DBURL : 'mongodb://kaokao:kao123456kao@115.29.44.230:27017/admin',
   /* DB: 'doracms',
    HOST: '',
    PORT: 27017,
    USERNAME: 'kaokao',
...
//    站点基础信息配置
    ...
    SYSTEMTEMPFORDER : process.cwd()+'/views/web/', // 系统模板安装目录
    ...
    SITEKEYWORDS : '克拉玛依家居建材行业协会',
    SITEBASICKEYWORDS : '克拉玛依家居建材行业协会', // 基础关键词


    SYSTEMMANAGE : new Array('sysTemManage','后台管理'),  // 后台模块(系统管理)
